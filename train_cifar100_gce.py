...
def main():
    ...
    parser.add_argument('--aug', type=str, default='standard', help='Type of data augmentation {none, standard, strong}')
    ...
    parser.add_argument('--e_warm', type=int, default=120, help='warm-up epochs without discarding any samples')
    ...
    if args.teacher_path is None:
        exp_name = 'gce_cifar100_{}{:.1f}_dp{:.1f}_aug{}_seed{}'.format(args.noise_pattern, args.noise_rate, args.dp, args.aug, args.seed)
    else:
        exp_name = 'gce_cifar100_{}{:.1f}_dp{:.1f}_aug{}_student_seed{}'.format(args.noise_pattern, args.noise_rate, args.dp, args.aug, args.seed)
    ...
    if args.teacher_path is not None:
        teacher_model = Wide_ResNet(args.dp, num_classes=100, use_log_softmax=False).to(device)
    ...
    model = Wide_ResNet(args.dp, num_classes=100, use_log_softmax=False).to(device)
