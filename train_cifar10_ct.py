...
def main():
    ...
    if args.teacher_path is None:
        exp_name = 'ct_cifar10_{}{:.1f}_warm{}_dp{:.1f}_aug{}_seed{}'.format(args.noise_pattern, args.noise_rate, args.e_warm, args.dp, args.aug, args.seed)
    else:
        exp_name = 'ct_cifar10_{}{:.1f}_warm{}_dp{:.1f}_aug{}_student_seed{}'.format(args.noise_pattern, args.noise_rate, args.e_warm, args.dp, args.aug, args.seed)
    ...
    model1 = Wide_ResNet(args.dp).to(device)
    model2 = Wide_ResNet(args.dp).to(device)
